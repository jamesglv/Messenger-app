...
class ConversationsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loginObserver = NotificationCenter.default.addObserver(forName: .didLogInNotifications, object: nil, queue: .main, using: { [weak self] _ in
    ...
    private func createNewConversation(result: SearchResult){
        ...
        // TO DELETE CURRENT MESSAGES - SEE VIDEO 17, 32 MINUTES
