...
//      }
            ...
            ref.observeSingleEvent(of: .value, with: { [weak self] snapshot in
                ...
                self?.database.child("\(otherUserEmail)/conversations").observeSingleEvent(of: .value,
                    ...
                    if var conversations = snapshot.value as? [[String: Any]] {
                        ...
                        self?.database.child("\(otherUserEmail)/conversations").setValue(conversations) //conversationId
    ...
    /// Creates collection of messages for given email
    ...
    public func sendMessage(to conversation: String, otherUserEmail: String, name: String, newMessage: Message, completion: @escaping (Bool) -> Void){
        ...
        database.child("\(conversation)/messages").observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            guard let myEmailAddress = UserDefaults.standard.value(forKey: "email") as? String else {
                completion(false)
                return
            }

            let currentUserEmail = DatabaseManager.safeEmail(emailAddress: myEmailAddress)
    ...
    public func deleteConversation(conversationId: String, completion: @escaping (Bool) -> Void){
        ...
        //Reset those convos for user in DB
    ...
    public func conversationExists(with targetRecipientEmail: String, completion: @escaping (Result<String, Error>) -> Void) {
        ...
        database.child("\(safeRecipientEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
            ...
            //reiterate and find in conversation with target sender
